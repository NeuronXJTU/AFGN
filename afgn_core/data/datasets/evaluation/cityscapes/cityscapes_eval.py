...
from afgn_core.modeling.roi_heads.mask_head.inference import Masker
from afgn_core.structures.bounding_box import BoxList
from afgn_core.structures.boxlist_ops import boxlist_iou

from afgn_core.data.datasets.evaluation.cityscapes import eval_instances
...
def do_cityscapes_evaluation(
    ...
    logger = logging.getLogger("afgn_core.inference")
