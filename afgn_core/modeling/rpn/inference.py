...
from afgn_core.modeling.box_coder import BoxCoder
from afgn_core.structures.bounding_box import BoxList
from afgn_core.structures.boxlist_ops import cat_boxlist
from afgn_core.structures.boxlist_ops import boxlist_nms
from afgn_core.structures.boxlist_ops import remove_small_boxes
...
class RPNPostProcessor(torch.nn.Module):
    ...
    def forward_for_single_feature_map(self, anchors, objectness, box_regression):
        ...
        if self.onnx_export:
            ...
            # assert torch.eq(topk_idx.size(0), torch.tensor([1], dtype=torch.long)), "topk_idx size must be 1"
        ...
        for proposal, score, im_shape in zip(proposals, objectness, image_shapes):
            ...
            # print(boxlist.get_field("objectness"))
