...
_C.MODEL.VID.RPN.REF_POST_NMS_TOP_N = 300

# AFGN
_C.MODEL.VID.AFGN = CN()
_C.MODEL.VID.AFGN.KEY_FRAME_LOCATION = 0
_C.MODEL.VID.AFGN.REF_NUM = 2
_C.MODEL.VID.AFGN.MAX_OFFSET = 5
