...
from afgn_core.utils.comm import get_world_size, synchronize
from afgn_core.utils.metric_logger import MetricLogger
...
def do_train(
    ...
    logger = logging.getLogger("afgn_core.trainer")
