...
from afgn_core.data.build import make_data_loader_test
...
from afgn_core.data import make_data_loader_test
...
from afgn_core.utils.miscellaneous import mkdir
...
def main():
    ...
    save_dir = ""
    logger = setup_logger("afgn_core", save_dir, get_rank())
    ...
    data_loaders_val = make_data_loader_test(cfg, is_train=False, is_distributed=distributed)
